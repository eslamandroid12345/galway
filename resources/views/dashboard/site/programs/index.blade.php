                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{route('programs.create',$center_programme_id)}}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="operations-btns" style="">
                                                ...
                                                <a href="{{ route('lectures.index', $program->id) }}"
                                                   class="btn  btn-primary">@lang('dashboard.lectures')</a>
                                                @endpermission
                                            </div>
                                        </td>
                                    </tr>
