...
@section('title', __('titles.programs'))
@section('content')
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">@lang('dashboard.programs')</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                                ...
                                <div class="container">
                                    ...
                                    <form action="{{ route('programs.update',$program->id) }}" method="post"
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea required name="desc_ar" class="form-control" id="summernote2"
                                                          placeholder="">{{ $program->desc_ar }}</textarea>
                                            </div>
                                            @error('desc_ar')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea required name="desc_en" class="form-control" id="summernote"
                                                          placeholder="">{{ $program->desc_en }}</textarea>
                                            </div>
                                            @error('desc_en')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <img src="{{ asset($program->image?->path)}}" width="200px" height="auto">
                                        </div>
                                        <div>
                                            <button type="submit"
