                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">@lang('dashboard.scientific-papers')</h3>
                            @permission('scientific-papers-create')
                            <div class="card-tools">
                                <a href="{{route('scientific-papers.create')}}"
                            ...
                            <table class="table table-bordered">
                                ...
                                @forelse($papers as $key => $paper)
                                    <tr>
                                        ...
                                        <td><img src="{{ asset($paper->firstImage)}}" width="100px" height="auto">
                                        </td>
                                        <td>
                                            <div class="operations-btns" style="">
                                                @permission('scientific-papers-update')
                                                <a href="{{ route('scientific-papers.edit', $paper->id) }}"
                                                   class="btn  btn-dark">@lang('dashboard.Edit')</a>
                                                @endpermission
                                                @permission('scientific-papers-read')
                                                <a href="{{ route('scientific-papers.show', $paper->id) }}"
                                                   class="btn  btn-dark">@lang('dashboard.Show')</a>
                                                @endpermission

                                                @permission('scientific-papers-delete')
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content float-left">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form
                                                                    action="{{route('scientific-papers.destroy' , $paper->id)}}"
                                                                    method="post">
                                                                    @csrf
                                                                    {{method_field('DELETE')}}
                                                                    <button type="submit"
