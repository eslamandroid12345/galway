                ...
                <div class="container-fluid">
                    <div class="col-12">
                        <div class="container">
                            <div class="card">
                                <div class="container">
                                    <h6>@lang('dashboard.center-publications')</h6>
                                    <form action="{{ route('center-publications.store') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div>
