...
@section('title', __('titles.center-publications'))
@section('content')
        ...
        <div class="container-fluid">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>@lang('dashboard.center-publications')</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="{{route('/')}}">@lang('dashboard.Structure')</a></li>
                                <li class="breadcrumb-item active">@lang('dashboard.center-publications')</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                    <div class="col-12">
                        <div class="container">
                            <div class="card">
                                <div class="container">
                                    <h4>@lang('dashboard.center-publications')</h4>
                                    <form action="{{ route('center-publications.update',$publication->id) }}" method="post" enctype="multipart/form-data">
                                        @csrf @method('put')
                                        <div>
                                            <label for="writer_name">@lang('dashboard.writer_name'):</label>
                                            <input type="text" name="writer_name" id="writer_name" class="form-control"
                                                   value="{{  $publication->writer_name }}"
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea required name="desc_ar" class="form-control" id="summernote2"
                                                          placeholder="">{{  $publication->desc_ar }}</textarea>
                                            </div>
                                            @error('desc_ar')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea required name="desc_en" class="form-control" id="summernote"
                                                          placeholder="">{{  $publication->desc_en }}</textarea>
                                            </div>
                                            @error('desc_en')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            @isset($publication->image?->path)
                                                <img src="{{ asset($publication->image?->path)}}" width="200px" height="auto">
                                            @endisset
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            @isset($publication->view_link)
                                            <iframe width="50%" height="auto"
                                                    src="{{asset($publication->view_link)}}"></iframe>
                                            @endisset
                                            @error('view_link')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div>
                                            <label for="link_to_paper_copy">@lang('dashboard.link_to_paper_copy'):</label>
                                            <input type="text" name="link_to_paper_copy" id="link_to_paper_copy" class="form-control"
                                                   value="{{  $publication->link_to_paper_copy }}"
