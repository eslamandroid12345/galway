                                ...
                                <div class="container">
                                    ...
                                    <form action="{{ route('abouts.update',$about->id) }}" method="post"
                                        ...
                                        <div>
                                            ...
                                            <input type="text" name="second_title_ar" id="second_title_ar"
                                                   class="form-control"
                                                   value="{{ $about->second_title_ar }}"
                                        ...
                                        <div>
                                            ...
                                            <input type="text" name="second_title_en" id="second_title_en"
                                                   class="form-control"
                                                   value="{{ $about->second_title_en }}"
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea required name="desc_ar" class="form-control" id="summernote2"
                                                          placeholder="">{{ $about->desc_ar }}</textarea>
                                            </div>
                                            @error('desc_ar')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea required name="desc_en" class="form-control" id="summernote"
                                                          placeholder="">{{ $about->desc_en }}</textarea>
                                            </div>
                                            @error('desc_en')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <img src="{{ asset($about->image?->path)}}" width="200px" height="auto">
                                        </div>
                                        <div>
                                        ...
                                        <div class="form-group clearfix">
                                            <div class="icheck-dark d-inline">
                                                <input name="structure_tree" type="checkbox"
                                                       {{ $about->structure_tree==1 ?'checked':'' }}
                                                       id="checkboxPrimary2">
