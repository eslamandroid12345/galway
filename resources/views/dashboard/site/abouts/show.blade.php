                                ...
                                <div class="col-12">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tr>
                                                <th style="width:50%">@lang('dashboard.second_title_ar'):</th>
                                                <td>{{$about->second_title_ar}}</td>
                                            </tr>
                                            <tr>
                                                <th style="width:50%">@lang('dashboard.second_title_en'):</th>
                                                <td>{{$about->second_title_en}}</td>
                                            </tr>
                                            ...
                                            <tr>
                                                <th style="width:50%">@lang('dashboard.sort'):</th>
                                                <td>{{$about->sort}}</td>
                                            </tr>
                                            <tr>
                                                <th style="width:50%">@lang('dashboard.Image'):</th>
                                                <td><img src="{{ asset($about->image?->path)}}" width="200px"
                                                         height="auto">
                                                </td>
                                            </tr>
