                                    ...
                                    <form action="{{ route('articles.update',$article->id) }}" method="post"
                                        ...
                                        <select class="custom-select" name="category_id">
                                            @foreach($categories as $category)
                                                <option
                                                    value="{{$category->id}}" {{ $article->category_id==$category->id?'selected':'' }}>{{$category->t('title')}}</option>
                                            @endforeach
                                        </select>
                                        <div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea required name="desc_ar" class="form-control" id="summernote2"
                                                          placeholder="">{{ $article->desc_ar }}</textarea>
                                            </div>
                                            @error('desc_ar')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea required name="desc_en" class="form-control" id="summernote"
                                                          placeholder="">{{$article->desc_en }}</textarea>
                                            </div>
                                            @error('desc_en')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
