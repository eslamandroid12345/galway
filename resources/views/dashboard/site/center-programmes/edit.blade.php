                        ...
                        <div class="container">
                            <div class="card">
                                <div class="container">
                                    ...
                                    <form action="{{ route('center-programmes.update',$programme->id) }}" method="post" enctype="multipart/form-data">
                                        @csrf @method('put')
                                        <label for="type">@lang('dashboard.type'):</label>
                                        <select class="custom-select" name="type">
                                            <option value="programs" {{old('type')=='programs' || $programme->type=='programs'?'selected':''}}>@lang('dashboard.programs')</option>
                                            <option    value="symposiums" {{old('type')=='symposiums' || $programme->type=='symposiums'?'selected':''}}>@lang('dashboard.symposiums')</option>
                                        </select>
                                        <div>
                                            <label for="title_ar">@lang('dashboard.title_ar'):</label>
                                            <input type="text" name="title_ar" id="title_ar" class="form-control"
                                                   value="{{ $programme->title_ar }}"
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea required name="desc_ar" class="form-control" id="summernote2" placeholder="">{{ $programme->desc_ar }}</textarea>
                                            </div>
                                            @error('desc_ar')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea required name="desc_en" class="form-control" id="summernote" placeholder="">{{ $programme->desc_en }}</textarea>
                                            </div>
                                            @error('desc_en')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <img src="{{ asset($programme->image?->path)}}" width="200px" height="auto">
                                        </div>
                                        <div>
                                            <button type="submit"
