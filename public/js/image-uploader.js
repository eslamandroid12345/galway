...
(function ($) {
    ...
    $.fn.imageUploader = function (options) {
        ...
        let defaults = {
            ...
            extensions: ['.jpg', '.jpeg', '.png', '.gif', '.svg', '.tif', '.tiff', '.webp', '.heif', '.heic', '.JPG', '.JPEG', '.PNG', '.GIF', '.SVG'],
            mimes: [
                'image/jpeg', 'image/jpeg', 'image/png', 'image/gif', 'image/svg+xml',
                'image/tiff', 'image/tiff', 'image/webp', 'image/heif', 'image/heif',
                'image/jpeg', 'image/jpeg', 'image/png', 'image/gif', 'image/svg+xml'
            ],
            maxSize: undefined,
            maxFiles: undefined,
