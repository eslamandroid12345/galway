...
abstract class Repository implements RepositoryInterface
{
    ...
    public function getAll(array $columns = ['*'], array $relations = [],$orderByColumn = 'id',$orderByValue = 'ASC'): Collection
    {
        return $this->model->with($relations)->orderBy($orderByColumn, $orderByValue)->get($columns);
    }
